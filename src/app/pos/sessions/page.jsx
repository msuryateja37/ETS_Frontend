            ...
            <div className="min-h-screen bg-background">
                ...
                <main className="max-w-7xl mx-auto px-6 py-12">
                    ...
                    <div className="flex flex-col items-center justify-center py-24 text-center">
                        <div className="p-6 rounded-3xl bg-blue-500/10 border border-blue-500/30 mb-6">
                            <Clock className="w-12 h-12 text-blue-400" />
                        </div>
                        <h1 className="text-3xl font-black text-foreground mb-3">My Sessions</h1>
                        <p className="text-muted-foreground max-w-md">
                            Full session history and management is available from the{" "}
                            <button
                                onClick={() => router.push("/pos")}
